...
class NewDetail extends Component {
    ...
    save(e) {
        ...
        GroupProductService.save(this.props.detailState,this.sendButton).then(response => {
            ...
            console.log('ERRO [components\\private\\appointmentbookconfiguration\\detail\\NewDetail.js 36]');
        });
    }

    render() {
        return (
            <Detail title="Cadastro de Configuração de Caderneta"
...
const NewAppointmentBookDetailConfigurationContainer = connect(mapStateToProps,mapDispatchToProps)(NewDetail);

export default NewAppointmentBookDetailConfigurationContainer;