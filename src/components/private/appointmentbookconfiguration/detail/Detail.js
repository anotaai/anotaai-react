    ...
    render() {
        return (
            <div className="space-container">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="input-field col s12 m12 l12">
                                        ...
                                        <label htmlFor="nome" className={this.props.nome !== '' ? 'active' : ''}>Descrição</label>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="input-field col s12 m12 l12">
                ...
                <ModalConfirm content="Confirma a exclusão da Configuração De Caderneta?" confirm={this.props.remove !== undefined ? this.props.remove.bind(this) : undefined} hideModal={this.props.hideModal} showModalState={this.props.showModalState} />
            </div>
        );
    }
}