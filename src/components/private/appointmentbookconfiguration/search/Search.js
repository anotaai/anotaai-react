        ...
        return (
            <div className="space-container">
                <div className="container">
                    <PanelHeader icon="business_center" label="Configuração de Caderneta" />
                    <div className="panel">
                        <form onSubmit={this.search.bind(this)}>
                            ...
                            <DataList filteredResults={this.props.searchState.filteredResults} editUrl={URL.GROUP_PRODUCT} remove={this.remove.bind(this)} showModal={this.props.showModal} hideModal={this.props.hideModal} showModalState={this.props.searchState.showModalState} text="Confirma a exclusão da Configuração de Caderneta?" />
