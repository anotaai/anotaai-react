    ...
    return (
        <span>
            {props.isRecommendEdition &&
                <button ref={props.submitRef} className="btn waves-effect buttons-space INFO">
                ...
                <li>
                    <div className="row">
                        ...
                        <div className="col col s2">
                            <button className="btn-floating INFO" formNoValidate><i className="material-icons">mail</i></button>
                        </div>
                    </div>
                </li>}
            <li>
