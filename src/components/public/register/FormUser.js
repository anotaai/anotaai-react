                ...
                <div className="container">
                    ...
                    <div className="panel row">
                        ...
                        <div className="input-field col s12 m6 l6">
                            <input id="nome" ref={this.props.inputRef} type="text" value={this.props.usuario.nome} name="usuario.nome" disabled={disabled} onChange={this.props.handleInputChange} required />
                        ...
                        {this.props.cliente !== undefined &&
                            <div className="input-field col s12 m6 l6">
                                <input id="nomeComercial" type="text" value={this.props.cliente.nomeComercial} name="cliente.nomeComercial" onChange={this.props.handleInputChange} required />
                                <label htmlFor="nomeComercial">Nome Comercial</label>
                            </div>
                        }
                        {this.props.cliente !== undefined &&
                            <div className="input-field col s12 m6 l6">
                                <MaskedInput id='cpf' value={this.props.cliente.cpf} name="cliente.cpf" onChange={this.props.handleInputChange} mask="111.111.111-11" required placeholder="Cpf" />
                            </div>
                        }
                        <div className="input-field col s12 m6 l6">
                        ...
                        <div className="input-field col s12 m6 l6">
                            <input id="email" value={this.props.usuario.email} name="usuario.email" className="validate" disabled={disabled} onChange={this.props.handleInputChange} type="email" />
                            <label htmlFor="email" data-error="Email inválido" className={activeClass}>Email</label>
                        </div>
                        <div className="input-field col s12 m6 l6">
                            <input id="senha" ref="senha" type="password" className="validate" minLength="6" required value={this.props.usuario.senha} name="usuario.senha" onChange={this.props.handleInputChange} />
